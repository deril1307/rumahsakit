    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-8 border-blue-600">
                <div class="p-8">
                    ...
                    <p class="text-lg text-gray-700">
                        ...
                        <span class="font-bold text-blue-700 bg-blue-50 px-2 py-1 rounded uppercase tracking-wide">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {{-- Card 1: Total Sesi --}}
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="p-6 flex flex-col items-center justify-center text-center">
                        ...
                        <div class="text-base font-semibold text-gray-600 uppercase tracking-wide">Total Sesi Terapi</div>
                    </div>
