                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="flex flex-wrap justify-between items-center gap-4">
                            ...
                            <form method="GET" action="{{ route('admin.pasien.index') }}"
                                ...
                                {{-- Tombol Clear Search (muncul jika ada search) --}}
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        ...
                        <form method="POST" :action="formAction">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input x-model="form.nama" id="nama" class="block mt-1 w-full"
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input x-model="form.no_rm" id="no_rm" class="block mt-1 w-full"
                                    type="text" name="no_rm" required maxlength="6"
