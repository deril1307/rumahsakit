<x-app-layout>
    ...
    {{-- 
        ...
        - showDeleteModal: untuk kontrol modal hapus
        - deleteUrl: untuk menyimpan URL hapus sementara
        - deleteName: untuk menyimpan nama orang yang mau dihapus (agar pesan lebih personal)
    --}}
    <div x-data="{ 
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-3">
                                                    ...
                                                    <button 
                                                        @click="openDeleteModal('{{ route('admin.terapis.destroy', $terapis->id) }}', '{{ $terapis->name }}')"
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        ...
                        <form method="POST" :action="formAction">
                            ...
                            <div class="flex justify-end space-x-2 mt-6">
                                ...
                                <button type="submit" class="px-4 py-2 bg-green-700 text-white rounded-md font-semibold text-xs uppercase tracking-widest hover:bg-green-800">Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <h3 class="text-lg font-semibold leading-6 text-gray-900" id="modal-title">
                                    Konfirmasi Hapus Terapis
                                </h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Apakah Anda yakin ingin menghapus data terapis <strong x-text="deleteName"></strong>? 
